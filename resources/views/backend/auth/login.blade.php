...
<head>
  ...
  <title>Admin - GCO SOFTWARE</title>
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

  <link rel="shortcut icon" href="http://test.gcosoftware.vn/gsoftware/uploads/config/logo/favicon1577929325-1524715552_favicon.png">
  <!-- Bootstrap 3.3.7 -->
