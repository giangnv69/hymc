...
<head>
    ...
    <link rel="shortcut icon" href="{{ url( 'uploads/config/logo/'.getOptions('setting', 'site_favicon') ) }}">
    <!-- Bootstrap 3.3.7 -->
...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview {{ Request::segment(2) === 'setting' || Request::segment(2) === 'slider' || Request::segment(2) === 'menu' || Request::segment(2) === 'widget' ? 'active' : null }}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ Request::segment(2) === 'setting' && Request::segment(3) == null ? 'active' : null }}">
                            <a href="{{ route('setting.get') }}"><i class="fa fa-circle-o"></i> Cấu hình chung</a>
                        </li>

                        <li class="{{ Request::segment(2) === 'menu' ? 'active' : null }}">
                            <a href="{{ route('setting.menu') }}"><i class="fa fa-circle-o"></i> Cấu hình menu</a>
                        </li>

                        <li class="{{ Request::segment(2) === 'widget' ? 'active' : null  }}">
                            <a href="{{ route('widget.get') }}">
                                <i class="fa fa-circle-o"></i> <span>Widget</span>
                            </a>
                        </li>

                        <li class="{{ Request::segment(3) === 'social' ? 'active' : null  }}">
                            <a href="{{ route('social.get') }}">
                                <i class="fa fa-circle-o"></i> <span>Mạng xã hội</span>
                            </a>
                        </li>
                ...
                <li class="{{ Request::segment(2) === 'developer' ? 'active' : null  }}" style="display: none;">
                    <a href="{{ route('developer.finder') }}">
                        <i class="fa fa-file"></i> <span>CK FINDER</span>
                    </a>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div
                    class="box {{ Request::segment(2) ==  'post' && Request::segment(3) != '' ? 'custom-box' : null }} @yield('class_body')">
                <div
                        class="box-body
                  {{ Request::segment(2) == 'post' && Request::segment(3) != '' ? 'custom-box' : null }} @yield('class_body')">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2-2019 </strong>
        All rights reserved.
    </footer>
</div>
