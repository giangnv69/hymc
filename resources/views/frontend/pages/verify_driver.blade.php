                    ...
                    <div class="col-md-12">
                        <div class="form-right text-center max-upload">
                            <form action="" class="verify">
                                <div class="title-form text-center" style="justify-content: center;">Driver's License</div>
                                        ...
                                        <div class="upload-file" style="display: block;">
                                            <div class="content-upload">
												...
												<span class="dragBox" >
													...
													<input type="file" onChange="dragNdrop(event)" name="img_driver_license" ondragover="drag()" ondrop="drop()" id="uploadFile"  />
												</span>
...
@section('script')
    ...
    <script>
        ...
        $(".btn_submit_form_verify").on("click", function(e) {
            ...
            data.img_driver_license = $('.verify input[ name = img_driver_license ]')[0].files[0];
